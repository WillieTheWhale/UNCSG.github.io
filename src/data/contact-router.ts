...
export const contactDestinations: ContactDestination[] = [
  ...
  { id: "cabinet", office: "Office of the Chief of the Cabinet", person: "Finlay Cullen", title: "Chief of Cabinet", email: "fwcullen@unc.edu", summary: "For partnerships involving multiple cabinet departments or administration-wide implementation." },
